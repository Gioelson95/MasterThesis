...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\textwidth]{Hevner_clusters.png} 
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\textwidth]{Russel_va_model.png} 
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{MER_process.png} 
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\textwidth]{ML_vs_traditional.png} 
