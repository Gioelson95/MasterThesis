...
\newacronym{cens}{CENS}{Chroma Energy Normalized Statistics}
\newacronym{zcr}{ZCR}{Zero Crossing Rate}
\newacronym{auc}{AUC}{Area Under the Curve}
\newacronym{rmssd}{RMSSD}{Root Mean Square Squared Difference}
\newacronym{sdsd}{SDSD}{Standard Deviation Discrete Differences}
...
\begin{document}
	...
	\input{../chapters/2_background_MIR_MER_v3.tex} 
	\input{../chapters/3_background_EDA_v3.tex}
	\input{../chapters/4_state_of_the_art_v2.tex} 
	\input{../chapters/5_implementation_v2.tex} 
	\input{../chapters/6_results_v2.tex} 
	\input{../chapters/7_conclusions_v2.tex} 	
